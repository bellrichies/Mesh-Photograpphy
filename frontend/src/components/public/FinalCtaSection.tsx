...
export default function FinalCtaSection() {
  ...
  return (
    <section
      ref={ref}
      className={cn(
        'relative overflow-hidden bg-espresso py-12 sm:py-14 lg:py-16',
    ...
    >
      ...
      <div className="site-container relative z-10">
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,1fr)_auto]">
          ...
          <div
            className="reveal-up flex w-full flex-col gap-3 sm:w-auto sm:min-w-[280px] sm:flex-row lg:flex-col"
            style={{ '--reveal-delay': '120ms' } as CSSProperties}
          >
            <Link
              to="/booking"
              className="group inline-flex items-center justify-center gap-2.5 bg-bronze px-7 py-3.5 font-body text-[11px] font-semibold uppercase tracking-[0.16em] text-ivory transition-all duration-200 hover:bg-bronze-light hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/30 focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-espresso"
            >
              Book a Session
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2.5 border border-ivory/30 px-7 py-3.5 font-body text-[11px] font-semibold uppercase tracking-[0.16em] text-ivory/85 transition-all duration-200 hover:border-gold hover:text-ivory hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-gold focus:ring-offset-2 focus:ring-offset-espresso"
            >
              Get in Touch
        ...
        <div
          className="reveal-up mt-7 grid gap-3 border-t border-ivory/10 pt-5 sm:grid-cols-3"
