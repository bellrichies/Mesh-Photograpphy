...
|---|---|---|
| [`app_docs/prompts/backend.md`](prompts/backend.md) | PHP Developer / AI Coding Agent | Full implementation prompt for the PHP REST API backend |
| [`app_docs/prompts/frontend.md`](prompts/frontend.md) | React Developer / AI Coding Agent | Full implementation prompt for the React SPA frontend |
...
- `app_docs/prompts/backend.md`
- Source of truth: `app_docs/blueprint.md`, `app_docs/04-backend-architecture.md`, `app_docs/06-api-design.md`
...
- `app_docs/prompts/frontend.md`
- Source of truth: `app_docs/05-frontend-architecture.md`, `app_docs/06-api-design.md`, `app_docs/blueprint.md` (design system section)
- Deliverable: A running React SPA at `http://localhost:5173/` that connects to the backend API

### Coordination Points

The two engineers share:
1. **API contract** (`app_docs/06-api-design.md`) — agreed response shapes and endpoint paths
2. **TypeScript types** (`frontend/src/types/`) — both teams reference the same model definitions
3. **Brand tokens** — design system from `app_docs/blueprint.md` §21 (colors, fonts, spacing)
...
1. Update `app_docs/06-api-design.md` first (single source of truth)
...
| Document | Purpose |
|---|---|
| `app_docs/blueprint.md` | Original master technical blueprint |
| `app_docs/01-business_requirement_docs.md` | Business objectives, user stories, functional requirements |
| `app_docs/02-build_blueprint.md` | Technology stack, ADRs, directory structure, coding standards |
| `app_docs/03-system-architecture.md` | High-level system design, data flows, infrastructure |
| `app_docs/04-backend-architecture.md` | PHP MVC architecture, JWT, middleware, services, models |
| `app_docs/05-frontend-architecture.md` | React SPA architecture, routing, components, hooks |
| `app_docs/06-api-design.md` | Complete REST API endpoint reference with schemas |
| `app_docs/07-implementation-plan.md` | Phased task breakdown for backend and frontend |
| `app_docs/08-delivery_roadmap.md` | Timeline, milestones, release strategy |
| `app_docs/09-implementation_prompts.md` | This document — prompt index and usage guide |
| `app_docs/prompts/backend.md` | Full backend implementation prompt |
| `app_docs/prompts/frontend.md` | Full frontend implementation prompt |
